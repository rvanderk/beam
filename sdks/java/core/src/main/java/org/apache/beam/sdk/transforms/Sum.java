...
public class Sum {
  ...
  private static class SumIntegerFn extends Combine.BinaryCombineIntegerFn {
    ...
    public TenantAwareValue<Integer> apply(
        TenantAwareValue<Integer> a, TenantAwareValue<Integer> b) {
      return TenantAwareValue.of(b.getTenantId(), a.getValue() + b.getValue());
    }
  ...
  private static class SumLongFn extends Combine.BinaryCombineLongFn {
    ...
    @Override
    public TenantAwareValue<Long> apply(TenantAwareValue<Long> a, TenantAwareValue<Long> b) {
      return TenantAwareValue.of(b.getTenantId(), a.getValue() + b.getValue());
    }
  ...
  private static class SumDoubleFn extends Combine.BinaryCombineDoubleFn {
    ...
    @Override
    public TenantAwareValue<Double> apply(TenantAwareValue<Double> a, TenantAwareValue<Double> b) {
      return TenantAwareValue.of(b.getTenantId(), a.getValue() + b.getValue());
    }
