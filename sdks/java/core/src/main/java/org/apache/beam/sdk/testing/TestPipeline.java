...
public class TestPipeline extends Pipeline implements TestRule {
  ...
  public PipelineResult run(PipelineOptions options) {
    ...
    try {
      ...
      updatedOptions
          ...
          .setProviderRuntimeValues(StaticValueProvider.of("SYS0", providerRuntimeValues));
  ...
  private static class GetFromRuntimeValues<T>
    ...
    @Override
    public TenantAwareValue<T> apply(TenantAwareValue<Map<String, Object>> input) {
      return TenantAwareValue.of(input.getTenantId(), (T) input.getValue().get(key));
    }
  }
