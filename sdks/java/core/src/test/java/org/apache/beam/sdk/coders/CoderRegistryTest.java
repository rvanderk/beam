...
public class CoderRegistryTest {
  ...
  private class MyListCoder extends AtomicCoder<List> {
    @Override
    public void encode(List value, OutputStream outStream) throws CoderException, IOException {}

    @Override
    public List decode(InputStream inStream) throws CoderException, IOException {
